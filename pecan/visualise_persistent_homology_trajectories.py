...
from vineyards_oineus import compute_vineyards
...
def make_3d_feature_trajectory_plot(persistence_pairs, persistence_points):
    """Create 3D trajectory plot for persistent homology features."""
...
def make_2d_ph_trajectory_plot(
    persistence_pairs,
    persistence_points,
    diffusion_homology_persistence_pairs
):
    """Create 2D trajectory plot for persistent homology features."""
    # Check whether the number of features coincides for both diagram
    # vectors.
    assert len(persistence_pairs) == len(persistence_points)
...
if __name__ == '__main__':
    ...
    # fig = make_3d_vine_plot(persistence_pairs, persistence_points)
    # fig2 = make_2d_vine_plot(
    #     persistence_pairs,
    #     persistence_points,
    #     diffusion_homology_persistence_pairs
    # )
    ...
    fig = make_2d_vine_plot(X,diffusion_homology_persistence_pairs,dim=0)
    fig.savefig(f"./vine_{args.INPUT[:-4]}.png")
